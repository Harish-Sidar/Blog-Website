      ...
      <Box>
        ...
        {account === 'login' ? (
          <Wrapper>
            ...
            <LoginButton variant="contained" onClick={() => loginUser()} disabled={isLoading}>
              {isLoading ? 'Loading...' : 'Login'}
            </LoginButton>
            <Text style={{ textAlign: 'center' }}>OR</Text>
            <SignupButton onClick={() => toggleSignup()} style={{ marginBottom: 50 }} disabled={isLoading}>
          ...
          <Wrapper>
            ...
            <SignupButton onClick={() => signupUser()} disabled={isLoading}>
              {isLoading ? 'Loading...' : 'Signup'}
            </SignupButton>
            <Text style={{ textAlign: 'center' }}>OR</Text>
            <LoginButton variant="contained" onClick={() => toggleSignup()} disabled={isLoading}>
